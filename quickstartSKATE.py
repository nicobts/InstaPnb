...
insta_username = 'dirtyrings'
insta_password = 'troiachesei'
...
try:
    ...
    session.set_comments([u'Daaaamn!! 🔥🔥💯💯  @{}' ,u' Sick!! 💯💯 @{}' , u' 💯💯👍👍 @{}' , u'✨💫✨💫👍👍 @{}'  ,  u'👊🏼👊🏼💣🔥🔥 @{}'] , media='Video')
    #session.set_comments([u'😃😃😃☺️☺️☺️💯💯💯  @{}', u' 😃😃😃💯💯  @{}' , u'😃😃😃☺️☺️☺️💯💯💯  @{}', u'👌👍👌👍 @{}' , u' 💯💯👍👍 @{}' , u'😃😃😃👍👍 @{}'] , media=None)
    #session.set_dont_include(['friend1', 'friend2', 'friend3'])
    #session.set_dont_like(['pizza', 'girl'])
    session.set_user_interact(amount=3, randomize=True, percentage=80, media=None)
    #session.set_upper_follower_count(limit=5000)
    #session.set_lower_follower_count(limit = 300)
    ...
    session.interact_user_followers(['levibrown'], amount=10, randomize=True)
    session.interact_user_followers(['nick_garcia'], amount=10, randomize=True)
    session.interact_user_followers(['levisskateboarding'], amount=10, randomize=True)
    session.interact_user_followers(['nbnumeric'], amount=10, randomize=True)
    session.interact_user_followers(['nikesb'], amount=10, randomize=True)
    ...
    session.like_by_tags(['besttrick', 'skatergirls' ,'iloveskateboarding' ,'powellperalta' ,'skatecrunch', 'metrogrammed', 'skate' ,'skateboard' ,'skateboarding' ,'skater' ,
		'skateday' ,'skategram' ,'skateboardingisfun' ,'skateboarder' ,'skaters','skateordie' ,'skatephotoaday','skateallday', 'shralpin' ,'skateeveryday' ,
		'skatelife' ,'skateeverything' ,'trueskate' , 'skateboard', 'skate' , 'skatelife' , 'slappyhour' , 'skateanddestroy' , 'skater' , 'skateeveryday' ,
		'skateeverydamnday' , 'thrasher' , 'thrashermagazine' , 'thankyouskateboarding' ], amount=5, media=None)
