...
insta_username = 'maisonv9'
insta_password = 'MaisonVi9'
...
try:
    ...
    session.interact_user_followers(['aldieci'], amount=10, randomize=True)
    session.interact_user_followers(['amber_del_discipline'], amount=10, randomize=True)
    session.interact_user_followers(['bancomoda'], amount=10, randomize=True)
    session.interact_user_followers(['glamourshopalessia'], amount=10, randomize=True)
    session.interact_user_followers(['dolcelunashop'], amount=10, randomize=True)
    session.interact_user_followers(['gibi_trieste'], amount=10, randomize=True)
...
#session.comment_by_locations(['213385402/london-united-kingdom/'], amount=50)
    ...
    session.unfollow_users(amount=400, onlyInstapyFollowed = True, onlyInstapyMethod = 'FIFO', sleep_delay=60)
